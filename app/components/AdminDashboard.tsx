...
function getWhatsAppLink(booking: Booking, kind: "confirmed" | "modify" = "confirmed", changedDetails?: { bookingDate: string; startTime: string; endTime: string }, manageUrl?: string) {
...
function WhatsAppButton({ booking, kind = "confirmed", changedDetails, label }: { booking: Booking; kind?: "confirmed" | "modify"; changedDetails?: { bookingDate: string; startTime: string; endTime: string }; label: string }) {
