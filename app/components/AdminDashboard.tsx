...
type Booking = { id: string; customerName: string; customerPhone: string; customerEmail: string | null; bookingDate: string; startTime: string; endTime: string; notes: string | null; status: string; services: { name: string; startingPrice: number } | null; };
...
export function AdminDashboard() {
  ...
  async function loadBookings() {
    ...
    const { data, error } = await supabase.from("bookings").select("id, customerName, customerPhone, customerEmail, bookingDate, startTime, endTime, notes, status, services(name, startingPrice)").order("bookingDate", { ascending: true }).order("startTime", { ascending: true });
