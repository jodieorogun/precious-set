...
export default function Home() {
  return <main className="creative-home">
    <section className="creative-hero page-shell">
      ...
      <div className="creative-hero-photo"><Image src="/portfolio/03.jpeg" alt="French tip nail set by The Precious Set" width={900} height={1100} priority /><div className="creative-logo"><Image src="/precious-set-logo.png" alt="The Precious Set logo" width={230} height={180} /></div></div>
    </section>
