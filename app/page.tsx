...
export default function Home() {
  return <main className="creative-home">
    <section className="creative-hero page-shell">
      <div className="creative-hero-copy"><p className="eyebrow">The Precious Set · Leeds</p><h1>Sets with<br /><em>presence.</em></h1><Link className="creative-book" href="/book">Book an appointment <span>↗</span></Link></div>
