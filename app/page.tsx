...
export default function Home() {
  return <main className="creative-home">
    <section className="creative-hero page-shell">
      <div className="creative-hero-copy"><p className="eyebrow">The Precious Set · Leeds, UK</p><h1>Nails worth<br /><em>noticing.</em></h1><Link className="creative-book" href="/book">Book an appointment <span>↗</span></Link></div>
