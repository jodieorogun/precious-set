...
export default function Home() {
  return <main>
    ...
    <section className="details-grid page-shell"><div><p className="eyebrow">03 / Find us</p><h2>In the details.</h2><p>Based in<br />Leeds, United Kingdom</p></div><div className="social-card"><p className="eyebrow">04 / Stay close</p><h2><a className="social-link" href="https://www.instagram.com/the_precious_set/" target="_blank" rel="noreferrer">@the_precious_set ↗</a></h2><p>Follow The Precious Set on Instagram.</p><span className="social-sparkle">✦</span></div></section>
  </main>;
}
