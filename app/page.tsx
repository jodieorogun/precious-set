...
export default function Home() {
  return <main>
    ...
    <section className="details-grid page-shell"><div><p className="eyebrow">03 / Find us</p><h2>In the details.</h2><p>Location placeholder<br />London, United Kingdom</p></div><div className="social-card"><p className="eyebrow">04 / Stay close</p><h2>@thepreciousset</h2><p>Instagram / TikTok placeholder</p><span className="social-sparkle">✦</span></div></section>
  </main>;
}
