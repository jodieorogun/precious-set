...
begin
  ...
  if booking_record.status = 'pending' then
    ...
    set "bookingDate" = requested_date, "startTime" = requested_start, "endTime" = requested_end,
        "changeRequestDate" = null, "changeRequestStartTime" = null, "changeRequestEndTime" = null, "changeRequestStatus" = null
    where id = booking_record.id;
  else
    update public.bookings
    set "changeRequestDate" = requested_date, "changeRequestStartTime" = requested_start,
        "changeRequestEndTime" = requested_end, "changeRequestStatus" = 'submitted'
    where id = booking_record.id;
  end if;
end;
$$;
